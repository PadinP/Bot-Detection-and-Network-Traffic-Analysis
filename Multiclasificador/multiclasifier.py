...
import numpy as np
import pandas as pd
from Multiclasificador.models.individual import Diversity
from Multiclasificador.models.voting import build_voting_models
from Multiclasificador.utils.utils import estimators
...
class Multiclasifier:
    def __init__(self):
        ...
        self.metrics = None
        self.database = 'files/characterization_database.txt'
    ...
    def evaluate(self):
        ...
        list_models = []
        path_models = f'Multiclasificador/voting/models_and_evaluation/models/*.pickle'
        ...
        detection_logger.info(f"all_predictions: {counts}")
