...
class KNNClassifier(KNeighborsClassifier):
    def __init__(self, n_neighbors=5, escenario="3", test_size=0.2, k=5):
        ...
        self.escenario = "modulo/database-preprosesing/smote/"+ escenario + "/minmax/" + escenario + ".minmax_smote.pickle"
        self.escenario_noBalanced = "modulo/database-preprosesing/no_balanced/" + escenario + "/minmax/" + escenario + ".minmax.pickle"
