...
def managed_load(since=0, untilBot=5000, untilHuman=5000, e='0', smote=False):
    if smote:
        file = open("modulo/database-preprosesing/smote/" + e + "/minmax/" + e + ".minmax_smote.pickle", "rb")
    else:
        file = open("modulo/database-preprosesing/no_balanced/" + e + "/minmax/" + e + ".minmax.pickle", "rb")
