...
from modulo.preprocessdata.utils import create_folder
from modulo.preprocessdata.preprocess import data_cleaning, data_transform, class_balance
...
def preprocessing(data, scaler, sampler):
    ...
    folders = 'modulo/database-preprosesing/' + sampler + '/' + label + '/' + scaler + '/models'
    name_scaler_model = 'modulo/database-preprosesing/' + sampler + '/' + label + '/' + scaler + '/models/' + label + '.' + scaler + \
                        '_model.pickle '
    name_pca_model = 'modulo/database-preprosesing/' + sampler + '/' + label + '/' + scaler + '/models/' + label + '.' + scaler + \
                     '_PCA_model.pickle'
    name_scaled_data = 'modulo/database-preprosesing/' + sampler + '/' + label + '/' + scaler + '/' + label + '.' + scaler + '.pickle'
    name_sampled_data = 'modulo/database-preprosesing/' + sampler + '/' + label + '/' + scaler + '/' + label + '.' + scaler + '_' + \
                        sampler + '.pickle'
